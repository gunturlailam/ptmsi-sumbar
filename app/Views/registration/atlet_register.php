                    ...
                    <div class="col-lg-8">
                        <div class="registration-card">
                            <div class="registration-header">
                                <h2><i class="bi bi-person-plus-fill"></i> Daftar Atlet Baru</h2>
                            ...
                            <div class="p-4">
                                ...
                                <form action="<?= base_url('registration/atlet-register') ?>" method="post" enctype="multipart/form-data">
                                    <?= csrf_field() ?>

                                    <h5 class="mb-4"><i class="bi bi-person-circle"></i> Data Atlet</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label for="kategori_usia" class="form-label">Kategori Usia <span class="text-danger">*</span></label>
                                            <select class="form-select" id="kategori_usia" name="kategori_usia" required>
                                                <option value="">Pilih Kategori</option>
                                                <option value="U-12" <?= old('kategori_usia') == 'U-12' ? 'selected' : '' ?>>U-12</option>
                                                <option value="U-15" <?= old('kategori_usia') == 'U-15' ? 'selected' : '' ?>>U-15</option>
                                                <option value="U-18" <?= old('kategori_usia') == 'U-18' ? 'selected' : '' ?>>U-18</option>
                                                <option value="Senior" <?= old('kategori_usia') == 'Senior' ? 'selected' : '' ?>>Senior</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <label for="foto_atlet" class="form-label">Foto Atlet <span class="text-danger">*</span></label>
                                            <div class="upload-area">
                                                <i class="bi bi-camera fs-1 text-primary"></i>
                                                <p class="mt-2">Klik untuk upload foto</p>
                                                <input type="file" class="form-control" id="foto_atlet" name="foto_atlet"
                                                    accept=".jpg,.jpeg,.png" required>
                                                <small class="text-muted">Format: JPG, PNG. Maksimal 2MB</small>
                                            </div>
                                            div>
                                            <div class="col-md-6 mb-4">
                                                <label for="ktp_scan" class="form-label">Scan KTP/Kartu Identitas <span class="text-danger">*</span></label>
                                                <div class="upload-area">
                                                    <i class="bi bi-file-earmark-person fs-1 text-primary"></i>
                                                    <p class="mt-2">Klik untuk upload KTP</p>
                                                    <input type="file" class="form-control" id="ktp_scan" name="ktp_scan"
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            1. Data akan diperiksa oleh Klub<br>
                                            2. Setelah disetujui klub, dikirim ke Admin Provinsi<br>
                                            3. Admin Provinsi akan memverifikasi dan mengaktifkan profil<br>
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-success">
                                                <i class="bi bi-check-circle"></i> Daftar Atlet
                                            </button>
                                        </div>
                                </form>
                            </div>
