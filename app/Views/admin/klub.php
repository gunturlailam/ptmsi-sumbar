                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="editKlub(<?= $item['id_klub'] ?>)" title="Edit Klub">
                                        <i class="bx bx-edit"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="deleteKlub(<?= $item['id_klub'] ?>)" title="Hapus Klub">
