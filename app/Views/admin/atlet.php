                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-outline-primary btn-sm" onclick="editAtlet(<?= $item['id_atlet'] ?>)" title="Edit Atlet">
                                        <i class="bx bx-edit"></i>
                                    </button>
                                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="deleteAtlet(<?= $item['id_atlet'] ?>)" title="Hapus Atlet">
