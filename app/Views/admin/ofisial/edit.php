...
<div class="w-100 py-4 px-3">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h3 class="mb-2">
                <i class='bx bx-edit-alt me-2'></i>Edit Ofisial
            </h3>
            <p class="text-muted mb-0">Perbarui data ofisial</p>
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="<?= base_url('admin/ofisial/update/' . $ofisial['id_ofisial']) ?>">
                        <?= csrf_field() ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_hp" name="no_hp"
                                value="<?= old('no_hp', $user['nohp']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nomor_lisensi" name="nomor_lisensi"
                                value="<?= old('nomor_lisensi', $ofisial['nomor_lisensi']) ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="status" name="status" required>
                                <option value="aktif" <?= old('status', $ofisial['status']) === 'aktif' ? 'selected' : '' ?>>Aktif</option>
                                <option value="nonaktif" <?= old('status', $ofisial['status']) === 'nonaktif' ? 'selected' : '' ?>>Nonaktif</option>
                            </select>
