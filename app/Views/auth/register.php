...
<head>
    ...
    <title>Daftar - PTMSI Sumbar</title>
            ...
            <form action="<?= base_url('auth/register') ?>" method="POST" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <div style="position: relative;">
                        ...
                        <input type="password"
                            ...
                            required>
                        <i class="bi bi-eye-fill password-toggle" onclick="togglePassword('password_confirm')"></i>
                    </div>
                </div>
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="terms">
                        Saya setuju dengan <a href="#" target="_blank">Syarat & Ketentuan</a> yang berlaku
                    </label>
                </div>

                <button type="submit" class="btn-register">
                    <span><i class="bi bi-person-plus"></i> Daftar Sekarang</span>
                </button>
            </form>
    ...
    <script>
        ...
        function checkPasswordStrength() {
            ...
            if (strength <= 2) {
                ...
                hint.textContent = 'Password lemah - tambahkan huruf besar, angka, dan karakter khusus';
                hint.style.color = '#dc3545';
            } else if (strength <= 4) {
                strengthBar.classList.add('medium');
                hint.textContent = 'Password sedang - tambahkan karakter khusus untuk lebih kuat';
